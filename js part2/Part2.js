...
//{Занятие 3}
	// Условный оператор "?" («вопросительный знак») называют «тернарным оператором», так как этот оператор имеет три аргумента. Синтаксис оператора:
		// let result = условие ? значение1 : значение2;
	// Сначала вычисляется условие: если оно истинно, тогда возвращается значение1, в противном случае – значение2. Вложенные тернарные операторы допускаются, но они сильно усложняют читаемость кода, поэтому в этих случаях лучше использовать команду if else.
	
	// Конструкция switch заменяет собой сразу несколько if. Общий вид команды:
		// switch(x) {
		//   case 'value1': 
		//     ...
		//     break;
	...
	// Группировка «case». Несколько вариантов case, использующих один код, можно группировать. Например:
		// let day = 6;
		// switch (day) {
		...
		// }
	// Если break нет, то выполнение пойдёт ниже по следующим case, при этом остальные проверки игнорируются. Пример без break:
		// let score = 3;
		// switch (score) {
		//   case 1: 
		//   case 2: console.log('very bad');
		//   case 3: console.log('bad');
		//   case 4: console.log('good');
		//   default: console.log('excellent');
		// }
	// Так как break отсутствует, в консоль будет выведено: "bad" "good" "excellent"